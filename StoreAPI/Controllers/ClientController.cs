...
public class ClientController(IClientService clientService, ILogger<ClientController> logger) : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<ShowClientDTO>>> GetAllAsync()
    {
        ...
        return Ok(new Response<IEnumerable<ShowClientDTO>> { StatusCode = StatusCodes.Status200OK, Message = GlobalMessage.OK200, Data = clientList });
    }
    ...
    public async Task<ActionResult<ShowClientDTO>> GetAsync([FromRoute] int id)
    {
        ...
        return Ok(new Response<ShowClientDTO> { StatusCode = StatusCodes.Status200OK, Message = GlobalMessage.OK200, Data = client });
    }
    ...
    public async Task<ActionResult<ShowClientDTO>> UpdateAsync([FromRoute] int id, [FromBody] UpdateClientDTO updateClientDTO)
    {
        ...
        return Ok(new Response<UpdateClientDTO> { StatusCode = StatusCodes.Status200OK, Message = GlobalMessage.OK200, Data = updateClientDTO });
    }
